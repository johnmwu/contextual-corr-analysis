...
srun --mem=90GB --cpus-per-task=32 --partition=630 --output=/data/sls/temp/johnmwu/contextual-corr-analysis/mk_results8-rbfcka1.out mk_results8-rbfcka.sh &

srun --mem=240GB --cpus-per-task=32 --partition=630 --output=/data/sls/temp/johnmwu/contextual-corr-analysis/mk_results10-1-1.out mk_results10-1.sh &
