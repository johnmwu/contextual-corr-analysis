...
srun --mem=140GB --cpus-per-task=4 --gres=gpu:1 --partition=2080 --output=/data/sls/temp/johnmwu/contextual-corr-analysis/mk_results8-cca2.out mk_results8-cca.sh &
